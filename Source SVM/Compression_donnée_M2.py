        ...
        if any(".txt" in s for s in list):  # check whether directory have emotion label
            ...
            for x in list:
                if imghdr.what(x) in ['png']:  # Makes sure file is .png image
                    ...
                    if len(img) * len(img[0]) != 10000:  # Check if image is not down sampled 100x100
                    ...
                    if int(x[10:-4]) == 1:  # Image name are of type 'S005_001_00000002.png' looks at the part '00000002'
